...
minetest.register_craft({
    ...
    recipe = {
        ...
        {'xtraores:nickel_bar', 'group:stick', ''}, {'', 'group:stick', ''}
    }
})
minetest.register_craft({
    output = 'xtraores:axe_nickel',
    recipe = {
        {'', 'xtraores:nickel_bar', 'xtraores:nickel_bar'},
        {'', 'group:stick', 'xtraores:nickel_bar'}, {'', 'group:stick', ''}
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {'xtraores:platinum_bar', 'xtraores:platinum_bar', ''},
        {'xtraores:platinum_bar', 'group:stick', ''}, {'', 'group:stick', ''}
    }
})
minetest.register_craft({
    output = 'xtraores:axe_platinum',
    recipe = {
        {'', 'xtraores:platinum_bar', 'xtraores:platinum_bar'},
        {'', 'group:stick', 'xtraores:platinum_bar'}, {'', 'group:stick', ''}
    }
})
...
minetest.register_tool("xtraores:pickaxe_palladium", {
    ...
    tool_capabilities = {
        ...
        groupcaps = {
            cracky = {
                times = {[4] = 4.00, [1] = 1.85, [2] = 1.1, [3] = 0.55},
                uses = 45,
                maxlevel = 3
            }
        },
...
minetest.register_craft({
    ...
    recipe = {
        {'xtraores:palladium_bar', 'xtraores:palladium_bar', ''},
        {'xtraores:palladium_bar', 'group:stick', ''}, {'', 'group:stick', ''}
    }
})
minetest.register_craft({
    output = 'xtraores:axe_palladium',
    recipe = {
        {'', 'xtraores:palladium_bar', 'xtraores:palladium_bar'},
        {'', 'group:stick', 'xtraores:palladium_bar'}, {'', 'group:stick', ''}
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {'xtraores:cobalt_bar', 'group:stick', ''}, {'', 'group:stick', ''}
    }
})
minetest.register_craft({
    output = 'xtraores:axe_cobalt',
    recipe = {
        {'', 'xtraores:cobalt_bar', 'xtraores:cobalt_bar'},
        {'', 'group:stick', 'xtraores:cobalt_bar'}, {'', 'group:stick', ''}
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        ...
        {'', 'xtraores:steel_handle', ''}, {'', 'xtraores:steel_handle', ''}
    }
})
